...
export const sendEmail = async ({email, emailType, userId}: any)=>{
    ...
    try {
          ...
          const emailOptions = {
            ...
            html: `${emailType === "VERIFY"? `<p>Click <a href='${process.env.DOMAIN}/users/verifyemail?token=${hashedToken}'>here</a> to verify you email 
            or copy paste the below link in your browser<br>
            ${process.env.DOMAIN}/users/verifyemail?token=${hashedToken}
            </p>`: `<p>Click <a href='${process.env.DOMAIN}/users/resetPassword?token=${hashedToken}'>here</a> to reset you password}
            or copy paste the link below in your browser<br>
            ${process.env.DOMAIN}/users/resetPassword?token=${hashedToken}
            </p>`}`, 
          }
